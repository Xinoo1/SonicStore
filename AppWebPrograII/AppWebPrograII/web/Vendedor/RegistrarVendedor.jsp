   ...
   //Validar Correo
    ...
    else 
    {
        ...
        st.execute();
            ...
            out.println("Vendedor Ingresado Correctamente\n ");
    ...
    catch(SQLException e)
    {
                ...
                out.println("Error: No se pudo registrar el vendedor");
                out.println("<br /><br />");
                out.println("<a href='FormRegistrarVendedor.jsp'>Volver al registro</a>");
                out.println("Error: " +e);
    } 
